...
function neutral_comparison(modelName, f_ODE, x0, tspan, p)
	...
	plt=plot(sol_PBS.t,rE_PBS,title=Title,xlabel="time [s]",ylabel="estimated relative error",
	         dpi=300,xaxis=(:log10,[tmin,:auto]),yaxis=(:log10,[last(ytk),:auto]),ytick=ytk,
	         label="PBSR", legend=:bottomright)
...
#savefig("ObjRelErrPKA_stabilized.png");
#savefig("ObjRelErrPKA_stabilized.pdf");
...
#savefig("ObjRelErrCaMKIIs_stabilized.png");
#savefig("ObjRelErrCaMKIIs_stabilized.pdf")
...
#savefig("ObjRelErrChuaCircuit_stabilized.png");
#savefig("ObjRelErrChuaCircuit_stabilized.pdf")
